const fs = require("fs");
let src = fs.readFileSync("components/PWAInstallPrompt.tsx", "utf8");
...
fs.writeFileSync("components/PWAInstallPrompt.tsx", src, "utf8");
console.log("iOS banner added:", src.includes("Add to Home Screen"));
